...
function findimage()
{
     ...
     var key1 = String(document.getElementById("text").value);
     ...
     for(i=0; i<len; i++)
     {  
          var key2 = String(img[i].src);
          console.log(key2);
          if( key1.match(key2)){
               document.getElementById("result").innerHTML ='<img src=" '+img[i].src +'" width=200 height=200 alt="no image">';
                return;
          }
          else
          {
